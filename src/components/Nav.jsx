        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="upload-btn flex items-center">
              <Link to="/upload" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Upload</Link>
            </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <img
                      ...
                      src="/chat/docs/images/people/profile-picture-5.jpg"
                      alt="user photo"
                    />
                  </button>
                </div>
          ...
          <ul className="space-y-2 font-medium flex flex-col justify-between">
            ...
            <li>
              ...
              <div className="clear_convo pt-3 px-3 flex items-baseline ">
                ...
                <span><Link to="" className=''>Clear Conversation</Link></span>
              </div>
            </li>
