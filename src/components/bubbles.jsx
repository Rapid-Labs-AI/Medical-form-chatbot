...
function Bubbles() {
    ...
    // const [downloadToken, setDownloadToken] = useState(null); // Store download token
    ...
    const handlePromptSubmit = async (prompt) => {
        ...
        try {
            ...
            if (data.response) {
                ...
                // setDownloadToken(data.download_token); // Set the download token
    ...
    return (
        <>
            {/* <Navbar downloadToken={downloadToken} /> Pass the token to Navbar */}
                                ...
                                <div className="flex items-start gap-2.5 mb-6" key={index}>
                                    ...
                                    <div className="flex flex-col w-full max-w-full leading-1.5 p-4 border-gray-200 bg-white rounded-e-xl rounded-es-xl dark:bg-gray-700">
                                        <div className="flex items-center justify-between space-x-2 rtl:space-x-reverse">
                                            ...
                                            {/* <CopyToClipboard text={message.text} onCopy={onCopyText}>
